...
export interface RuntimeHealthSnapshot {
  ...
  activityLogWriteReverify: ReturnType<typeof activityLogWriteReverifyService.getStats>;
...
interface RuntimeHealthCollectorDeps {
  ...
  getActivityLogWriteReverifyStats?: () => ReturnType<typeof activityLogWriteReverifyService.getStats>;
...
export async function collectRuntimeHealthSnapshot(
  ...
  return {
    ...
    activityLogWriteReverify: (
      deps.getActivityLogWriteReverifyStats ??
      (() => activityLogWriteReverifyService.getStats())
    )(),
