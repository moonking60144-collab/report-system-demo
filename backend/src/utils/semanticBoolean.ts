...
/**
 * SQLite 欄位存的是 integer，所以寫入時把語意布林轉 1/0。
 * 無法辨識就回 null（與 parseSemanticBoolean 語意對齊）。
 */
export function parseSemanticBooleanToInteger(value: unknown): number | null {
