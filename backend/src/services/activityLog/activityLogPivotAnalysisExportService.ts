...
import { parseActivityLogPublishedCsv } from "./activityLogPublishedCsv";
...
export const ACTIVITY_LOG_PIVOT_CALCULATION_VERSION = "v2";

export interface ActivityLogPivotTemplateBundle {
  body: Buffer;
  version: string;
}
...
class ActivityLogPivotAnalysisExportService {
  async loadTemplateBundle(): Promise<ActivityLogPivotTemplateBundle> {
    try {
...
export const activityLogPivotAnalysisExportService = new ActivityLogPivotAnalysisExportService();
