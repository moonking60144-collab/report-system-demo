...
const SAMPLE_HTML = `
<html><body>
<h3><span style='color:#888;'>表單:</span>[901] 工令單</h3>
表單網址:<a href='https://demo.local/demo/work-orders/line-a' target='_blank'>...</a><br/>
<h4>主表單欄位</h4>
主表單Key: 9001042<table class='paramTable'>
<tr><th>欄位位置</th><th>對應欄位</th><th>欄位編號</th><th>欄位型態</th><th>備註</th></tr>
<tr><td>B1</td><td>工令單號</td><td>9001040</td><td>文字</td><td>唯讀</td></tr>
<tr><td>E1</td><td>工令種類</td><td>9001051</td><td>選項</td><td>預設值</td></tr>
</table>
</body></html>
`;
