...
const TARGETS: Target[] = [
  {
    label: "activity log (工令)",
    path: process.env.UPSTREAM_ACTIVITY_LOG_PATH ?? "/demo/activity-logs",
  },
  {
    label: "form 901",
    path: process.env.RAGIC_FORM_901_PATH ?? "/demo/work-orders/line-a",
  },
  {
    label: "form 902 (機台)",
    path: process.env.RAGIC_FORM_902_PATH ?? "/demo/work-orders/line-b",
  },
  {
    label: "source machine (機台清單)",
    path: process.env.RAGIC_SOURCE_MACHINE ?? "/demo/reference/machines",
  },
  {
    label: "source operator (人員)",
    path: process.env.RAGIC_SOURCE_OPERATOR ?? "/demo/reference/operators",
  },
  {
    label: "source process (製程)",
    path: process.env.RAGIC_SOURCE_PROCESS ?? "/demo/reference/processes",
  },
];
