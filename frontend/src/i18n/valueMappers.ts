...
const REPORT_TYPE_KEY_MAP: Record<string, string> = {
  "PROC-B": "workReport:values.reportType.processB",
  "PROC-A": "workReport:values.reportType.processA",
  "PROC-C": "workReport:values.reportType.processC",
  "PROC-D": "workReport:values.reportType.processD",
  "PROC-QA-MANUAL": "workReport:values.reportType.manualQa",
  "PROC-QA-MACHINE": "workReport:values.reportType.machineQa",
  "PROC-PACK": "workReport:values.reportType.packaging",
  "PROC-STOCK": "workReport:values.reportType.stock",
};
