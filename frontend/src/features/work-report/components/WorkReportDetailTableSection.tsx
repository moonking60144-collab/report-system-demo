...
import type { WorkReportDetailEditorMode } from "../hooks/detail/detailEditorMode";
...
export interface WorkReportDetailTableEditorViewModel {
  mode: WorkReportDetailEditorMode;
...
interface WorkReportDetailTableSectionProps {
  ...
  editor: WorkReportDetailTableEditorViewModel;
  loading: boolean;
  refreshing: boolean;
  submitting: boolean;
...
export const WorkReportDetailTableSection = memo(function WorkReportDetailTableSection({
  ...
  const batchCreateMode = mode === "batch-create";
  const batchDeleteMode = mode === "batch-delete";
  ...
  const isRecordClosed = isWorkOrderClosedStatus(recordStatus);
