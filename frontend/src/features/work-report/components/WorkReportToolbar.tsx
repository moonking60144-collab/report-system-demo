        ...
        <div className="page-view-toolbar">
          <div className="page-view-switch" role="tablist" aria-label={t("workReport:page.viewSwitchAria")}>
            <button
              type="button"
              role="tab"
              aria-selected={activeTopView === "report" && activeLandingPageKey === "line-a-901"}
              className={`page-view-chip ${
                activeTopView === "report" && activeLandingPageKey === "line-a-901" ? "is-active" : ""
              }`}
              onClick={() => onOpenLandingPage("line-a-901")}
            >
            ...
            <button
              type="button"
              role="tab"
              aria-selected={activeTopView === "report" && activeLandingPageKey === "line-b-902"}
              className={`page-view-chip ${
                activeTopView === "report" && activeLandingPageKey === "line-b-902" ? "is-active" : ""
              }`}
              onClick={() => onOpenLandingPage("line-b-902")}
            >
            ...
            <button
              ...
              disabled={efficiencyStatsBusy}
              aria-busy={efficiencyStatsBusy}
            >
              {efficiencyStatsBusy ? <LoadingSpinner size="small" /> : <CsvIcon size="1.05em" />}
              {t(efficiencyStatsBusy ? "workReport:efficiencyStats.downloadBusy" : "workReport:efficiencyStats.entry")}
            </button>
            <button
              type="button"
              role="tab"
