...
import {
  cacheSystemNoticeAvailabilitySnapshot,
  isSystemNoticeActive,
...
import { useSqliteAutoSyncStatus } from "../hooks/useSqliteAutoSyncStatus";
...
export function SystemNoticePanel({
  ...
  const activeState = useMemo(() => {
    ...
    return isSystemNoticeActive(notice);
  }, [notice]);
  ...
  const isInlineStatusSpinning = inlineStatusType === "loading" ||
    (refreshing && inlineStatusType !== "warn" && inlineStatusType !== "error");
