...
export interface CreateTaskMonitor {
  ...
  authoritativeRefreshMs?: number;
  confirmedEntry?: WorkReportConfirmedEntryFieldObservation;
  message: string;
  updatedAt: string;
  rowId?: string;
  stale?: boolean;
  retryableStale?: boolean;
  entryFieldOperation?: WorkReportEntryFieldMutationOperation;
  entryFieldClientMutationId?: string;
  entryFieldSettlementOutcome?: "settled" | "superseded";
  entryFieldSettlementRecord?: WorkReportRecord;
  entryFieldSettlementRetryAt?: number;
  entryFieldSettlementAttempts?: number;
...
export type WorkReportLandingPageKey = "line-a-901" | "line-b-902";
export type WorkReportFormId = "901" | "902";
...
export interface WorkReportLandingPageConfig {
  ...
  defaultFixedPresetPreferenceKey: "defaultFixedPresetId901" | "defaultFixedPresetId902";
...
export interface WorkReportLocalPreferences {
  ...
  defaultFixedPresetId901: FixedFilterPresetId;
  defaultFixedPresetId902: FixedFilterPresetId;
  hideTestCustomerPartRecords: boolean;
  hideSortOrder99Records: boolean;
  showListScrollHintButton: boolean;
}
...
export interface SavedWorkReportFilterPreset {
  schemaVersion: 1;
  id: string;
  name: string;
  formId: WorkReportFormId;
