...
function record(id = "1001"): ActivityLogDowntimeRecord {
  return {
    id,
    snapshotHash: "hash-1",
    date: "2026/08/12",
...
describe("downtimeOptimisticMutation", () => {
  ...
  it("delete indeterminate 保留 frozen lifecycle，但畫面回到 authoritative record", () => {
    ...
    expect(applyDowntimeOptimisticMutations([record()], [frozen])).toHaveLength(1);
