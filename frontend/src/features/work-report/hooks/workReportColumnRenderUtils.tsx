...
export function renderUrgentIndicator(value: unknown, label: string): ReactNode {
  if (parseSemanticBoolean(value) !== true) return "";
  return (
    <span className="urgent-indicator" aria-label={label} title={label}>
      ✓
    </span>
  );
}
