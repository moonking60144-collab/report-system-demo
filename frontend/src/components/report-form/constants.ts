...
export const REPORT_TYPE_VALUE = {
  ...
  PROCESS_C: "PROC-C",
  PROCESS_D: "PROC-D",
  QA_MANUAL: "PROC-QA-MANUAL",
  QA_MACHINE: "PROC-QA-MACHINE",
  PACKAGING: "PROC-PACK",
  STOCK: "PROC-STOCK",
} as const;

export const REPORT_TYPE_VALUES = [
  REPORT_TYPE_VALUE.PROCESS_B,
  REPORT_TYPE_VALUE.PROCESS_A,
  REPORT_TYPE_VALUE.PROCESS_C,
  REPORT_TYPE_VALUE.PROCESS_D,
  REPORT_TYPE_VALUE.QA_MANUAL,
  REPORT_TYPE_VALUE.QA_MACHINE,
  REPORT_TYPE_VALUE.PACKAGING,
  REPORT_TYPE_VALUE.STOCK,
] as const;
