...
export function inferReportTypeFromProcessCode(processCode: string): string {
  ...
  if (normalized.startsWith("A")) {
    return REPORT_TYPE_VALUE.PROCESS_A;
  }
  if (normalized.startsWith("B")) {
    return REPORT_TYPE_VALUE.PROCESS_B;
  }
  if (normalized.startsWith("C")) {
    return REPORT_TYPE_VALUE.PROCESS_C;
  }
  if (normalized.startsWith("D")) {
    return REPORT_TYPE_VALUE.PROCESS_D;
  }
  if (normalized.startsWith("PK")) {
    return REPORT_TYPE_VALUE.PACKAGING;
  }
  if (normalized.startsWith("ST")) {
    return REPORT_TYPE_VALUE.STOCK;
  }
  if (normalized.startsWith("QA")) {
    return REPORT_TYPE_VALUE.QA_MANUAL;
  }
  return "";
}
